...
from .views import CartDetailView, CartItemDetailView, AddToCartView, UpdateCartItemView, DeleteCartItemView, GetCartCount
...
urlpatterns = [
  ...
  path('get-cart-count/', GetCartCount.as_view(), name='get_cart_count'),
]